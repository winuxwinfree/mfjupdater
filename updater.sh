...
|/__\|/__\|/__\|/__\|/__\|/__\|
                     ...
                     ";
   echo "Once the patch has been applied, reboot and then right click on the volume icon,go to volume control options and change the command to open the mixer to alsamixer. This allows to open the advanced sound control panel by clicking on mixer options. After this the equalizer and pulse-audio options will not work.";
   sleep 30;;
q) echo "Done, closing.";
   sleep 3; exit 1;;
